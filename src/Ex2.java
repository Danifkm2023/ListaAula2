    ...
    public static void main(String[] args){
        ...
        if (combustivelAbastecido.equalsIgnoreCase("a")){
            if (qtdLitrosVendidos <= 20){
                ...
                System.out.println(" Valor sem desconto é R$ " + formatador.format(precoNormal));
                System.out.println(" Recebeu 3% de desconto, ficando o total de: R$ " + formatador.format(precoFinalComDesconto));
            } else {
                double descontoAlcool = (qtdLitrosVendidos * precoAlcool) * 0.05;
                double precoNormal = qtdLitrosVendidos * precoAlcool;
                double precoFinalComDesconto = (qtdLitrosVendidos * precoAlcool) - descontoAlcool;
                System.out.println(" Valor sem desconto é R$ " + formatador.format(precoNormal));
                System.out.println(" Recebeu 5% de desconto, ficando o total de: R$ " + formatador.format(precoFinalComDesconto));
            }
            ...
            if (qtdLitrosVendidos <= 20){
                ...
                System.out.println(" Valor sem desconto é R$ " + formatador.format(precoNormal));
                System.out.println(" Recebeu 4% de desconto, ficando o total de: R$ " + formatador.format(precoFinalComDesconto));
            } else {
                double descontoGasolina = (qtdLitrosVendidos * precoGasolina) * 0.06;
                double precoNormal = qtdLitrosVendidos * precoGasolina;
                double precoFinalComDesconto = (qtdLitrosVendidos * precoGasolina) - descontoGasolina;
                System.out.println(" Valor sem desconto é R$ " + formatador.format(precoNormal));
                System.out.println(" Recebeu 6% de desconto, ficando o total de: R$ " + formatador.format(precoFinalComDesconto));
            }
        }
